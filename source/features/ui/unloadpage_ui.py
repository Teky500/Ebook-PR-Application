...
"    }")
        ...
        self.unload.setStyleSheet("font: 700 50pt \"Segoe UI\";")
        ...
        self.unload_sheets.setMaximumSize(QtCore.QSize(1050, 60))
...
"")
        ...
        self.submit_button.setMaximumSize(QtCore.QSize(170, 60))
